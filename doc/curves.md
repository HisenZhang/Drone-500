...
This file records the result generated by cftool in MATLAB. For each curve, the result shows the polynomial model and coefficients, with quality evaluation message below. 
